...
public class QuesFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        op1  = findViewById(R.id.radioButton11);
        op2  = findViewById(R.id.radioButton12);
        op3  = findViewById(R.id.radioButton13);
        op4  = findViewById(R.id.radioButton14);

        //setting values for each options
        op1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(QuesFour.this, "You have selected option 1", Toast.LENGTH_SHORT).show();
            }
        });
        op2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(QuesFour.this, "You have selected option 2", Toast.LENGTH_SHORT).show();
            }
        });
        op3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(QuesFour.this, "You have selected option 3", Toast.LENGTH_SHORT).show();
                count++;
            }
        });
        op4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(QuesFour.this, "You have selected option 4", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent2 = new Intent(QuesFour.this, QuesFive.class);
